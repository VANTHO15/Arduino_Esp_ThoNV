...
volatile uint64_t Count1 = 0, Count2 = 0, Count3 = 0, Count4 = 0, Dem1 = 0, Dem2 = 0, Dem3 = 0, Dem4 = 0,BTN=0,Lan1NutBam=0,Click=0;
void setup()
{
  Serial.begin(9600);
  lcd.begin(20, 4);
...
void FuncBtnXacNhan()
{
  ...
  if((bT1>=1000)&&(bT1<1010))
  {
     HitTho=1/3.8;
  }
  else
  if((bT1>=1010)&&(bT1<=1023))
  {
    HitTho=1/4.0;
  }
    NhipTho = BT2.toInt();
...
void HienThiLCD()
{
  ...
  if (Mode == 2)
  {
    ...
    else
    {
      ...
      lcd.setCursor(0, 3);
      lcd.print(" Do Nhay: " + String(DoNhay) + "CmH20" );
    }
  }
}
void Timer001s()
