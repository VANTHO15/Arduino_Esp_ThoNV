...
int ARRvao[100]={55,55,55,55,55,55,55,55,55,55,55,55,55,55,55,  55,55,56,18,57,20,58,60,23,61,25,62,27,28,63,64,66,67,33,68,35,69,70,71,72,
                  73,74,75,76,77,78,79,80,81,82,83,84,85,53,86,87,88,89,91,92,93,94,95,96,97,98,100};
void setup()
{
  Serial.begin(9600);
  lcd.begin(20, 4);
