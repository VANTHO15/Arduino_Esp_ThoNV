...
volatile int Click = 0, Enter = 0, lan1Tho = 0, Xoa = 0;
void setup()
{
  Serial.begin(9600);
  lcd.begin(20, 4);
...
String FuncBienTro()
{
  ...
  else if ((BT3 >= 73) && (BT3 < 146))
  {
    TheTich = 150;
  }
  else if ((BT3 >= 146) && (BT3 < 219))
  {
    TheTich = 200;
  }
  else if ((BT3 >= 219) && (BT3 < 292))
  {
    TheTich = 250;
  }
  else if ((BT3 >= 292) && (BT3 < 365))
  {
    TheTich = 300;
  }
  else if ((BT3 >= 365) && (BT3 < 438))
  {
    TheTich = 350;
  }
  else if ((BT3 >= 438) && (BT3 < 511))
  {
    TheTich = 400;
  }
  else if ((BT3 >= 511) && (BT3 < 584))
  {
    TheTich = 450;
  }
  else if ((BT3 >= 584) && (BT3 < 657))
  {
    TheTich = 500;
  }
  else if ((BT3 >= 657) && (BT3 < 730))
  {
    TheTich = 550;
  }
  else if ((BT3 >= 730) && (BT3 < 803))
  {
    TheTich = 600;
  }
  else if ((BT3 >= 803) && (BT3 < 876))
  {
    TheTich = 650;
  }
  else if ((BT3 >= 876) && (BT3 < 900))
  {
    TheTich = 700;
  }
  else if ((BT3 >= 900) && (BT3 < 1000))
  {
    TheTich = 750;
  }
  else if ((BT3 >= 1000) && (BT3 < 1023))
  {
    TheTich = 800;
  }
  ...
  BT4 = map(BT4, 0, 1023, 10, 40); // van  toc
  //BT5 = map(BT5, 0, 1023, 0, 5); // Do Nhay
  BT5 = BT5 * 5 / 1023; // Do Nhay
//  float BT = BT1 / 100.0;
  String Dulieu = "a" + bt1 + "b" + String(BT2) + "c" + String(TheTich) + "d" + String(BT4) + "e"
                  + String(BT5)+ "f" ;
...
void HienThiLCD()
{
  ...
  if (Mode == 2)
  {
    if (TrangThaiHienThi == "ConFig")
    {
      ...
      lcd.setCursor(0, 1);
      lcd.print(" Ap Xuat : " + String(BT4) + " V/P" );
      lcd.setCursor(0, 2);
    ...
    else
    {
      ...
      lcd.setCursor(0, 2);
      lcd.print(" Ap Xuat : " + String(apxuat) + " Cm3" );
      lcd.setCursor(0, 3);
